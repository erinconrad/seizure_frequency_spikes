...
fprintf(fid, ['When restricting to patients with non-zero spike rates and seizure ' ...
    ...
    'frontal lobe epilepsy grew, although remained non-significant (&rho;=%.2f [%.2f-%.2f]; Fig. S5). '], ...
    format_p_html(temNZ.p_bonf), temNZ.Spearman_r, temNZ.ci_lo, temNZ.ci_hi,...
    frontNZ.Spearman_r, frontNZ.ci_lo, frontNZ.ci_hi);
...
fprintf(fid, ['After excluding the %.0f%% of patients with the highest spike rates ' ...
    ...
    'epilepsy patients, frontal, and generalized patients, suggesting that the overall ' ...
    'correlation was partially driven by patients with the highest spike rates ' ...
    '(Fig. S6). '], ...
